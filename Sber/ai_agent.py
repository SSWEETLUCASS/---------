...
1. Если это приветствие или начало общения (привет, здравствуй, что умеешь, начнем и т.д.) → CMD:start
2. Если пользователь описывает идею для AI-агента или при диалоге с развитием идеи говорит, что хочет ее оформить → CMD:idea
...
4. Если пользователь жалуется на проблему с ботом или просит помощь в использовании → CMD:help
5. Если хочет список всех AI-агентов → CMD:ai_agent
6. Если хочет консультацию (советы, рекомендации, что выбрать) → CMD:consultation
7. Если спрашивает про владельцев или информацию об агенте → CMD:search_owners
