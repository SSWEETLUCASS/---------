...
def check_general_message_with_gigachat(msg: str, user_id: int = None) -> tuple[str, str | None]:
    ...
    try:
        ...
        Проанализируй сообщение(может быть нестандартным, найди самое близкое) и определи:
        ...
        Отвечай ТОЛЬКО на русском языке, без дополнительной технической информации 1 сообщением. До 4000 слов.
        """
