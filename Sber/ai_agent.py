...
- Если заполнение =100%, сразу переходи к CMD:idea.
- Если <, уточняй по каждому пункту из шаблона, один за другим, пока не будет заполнено всё.
