...
2. Если пользователь описывает идею для AI-агента → CMD:idea
3. Если пользователь просит придумать или развить идею (помоги с идеей, предложи идею, что можно автоматизировать) → CMD:help_idea
